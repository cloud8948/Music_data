...
select billing_city ,sum(total) as sum_of_invoice from invoice group by billing_city
...
select first_name,last_name,sum(total) as sum_total from spent_more_money
group by first_name,last_name order by sum_total desc limit 1;


/* Q6: Write query to return the email, first name, last name, & Genre of all Rock Music listeners. 
Return your list ordered alphabetically by email starting with A. */

SELECT DISTINCT first_name, last_name,email, genre.name AS item_Name
FROM customer c
